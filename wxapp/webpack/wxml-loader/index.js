const { resolve, isAbsolute, relative, dirname, join } = require('path');
const sax = require('sax');
const { Script } = require('vm');
const Minifier = require('html-minifier');
const { isUrlRequest, urlToRequest, getOptions } = require('loader-utils');
...
const hasProtocol = (src) => /^(\w+:)?\/\//.test(src);
